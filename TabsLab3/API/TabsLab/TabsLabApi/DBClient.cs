...
using TabsLabApi.Models;


namespace TabsLabApi
{
    public class DBClient
    {
        ...
        {
            AuthSecret = "mYbGPejDGGHUR3cpVyExbk3nmgN5wX62GgUKlyhY",
            BasePath = $"https://tabslabweb-default-rtdb.europe-west1.firebasedatabase.app/"
        };
